...
/*  NOTE TO gmarkall-- change these gpios or better yet look at encore
    where I use the actual volume buttons instead of just power + home.
    encore will probably be a much better model for this stuff. */
