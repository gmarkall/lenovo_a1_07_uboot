...
omap3621_edp1_tft_config :    unconfig
...
###/* <--LH_SWRD_CL1_Mervins@2011.8.02 */
omap3621_edp1_tft_3g_config :    unconfig
	$(MAKE) omap3621_edp1_config
	echo '#define CFG_TFT_DISPLAY (1)' >> include/config.h
	echo "#define CONFIG_CL1_3G_VERSION" >> include/config.h 
	svn info > svninfo
	sed -n 's/Last Changed Rev\:/#define CONFIG_SVN_REVISION/p' svninfo  >> include/config.h
###/* LH_SWRD_CL1_Mervins@2011.08.02--> */
