...
#elif defined(CONFIG_3621EDP1) && defined(CONFIG_SDRAM_MT46H32M32LFCM)
  #define SDP_SDRC_MDCFG_0_DDR	(0x03584099)	 /* Micron 1Gb SDRAM MT46H32M32LFCM module */
#elif defined(CONFIG_3621EDP1) && defined(CONFIG_SDRAM_MT46H64M32LF)
  #define SDP_SDRC_MDCFG_0_DDR	(0x03588099)	 /* Micron 2Gb SDRAM MT46H64M32LF module */
//&*&*&*20110223_Peter ++
#elif defined(CONFIG_3621EDP1) && defined(CONFIG_DDR_EDK2232CBBH_50_F)
	#define SDP_SDRC_MDCFG_0_DDR	(0x03588099)	 /* ELPIDA 2Gb Mobile DDR EDK2232CBBH-50-F module */
//&*&*&*20110223_Peter --
...
#if defined(CONFIG_3621EDP1) && defined(CONFIG_SDRAM_MT46H64M32LF)
#define SDP_3430_SDRC_RFR_CTRL_165MHz   0x0009f601 /* 15.6us/6ns - 50=0x9f6 */
#elif defined(CONFIG_3621EDP1) && defined(CONFIG_DDR_EDK2232CBBH_50_F)
#define SDP_3430_SDRC_RFR_CTRL_200MHz	0x0005e601
#define SDP_3430_SDRC_RFR_CTRL_165MHz	0x0004e201
#else
#define SDP_3430_SDRC_RFR_CTRL_165MHz   0x0004e201 /* 7.8us/6ns - 50=0x4e2 */
#endif
#define ZOOM3_3630_RFR_CTRL_200MHz	0x0005e601

#define DLL_FIXEDDELAY          0xf
#define DLL_OFFSET              0
...
#else
#define SDP_SDRC_DLLAB_CTRL ((DLL_ENADLL << 3) | \
    (DLL_LOCKDLL << 2) | (DLL_DLLPHASE_90 << 1) | (DLL_FIXEDDELAY << 24) | (3<<16))
#endif
//&*&*&*20110223_Peter --
...
#elif defined(CONFIG_3621EDP1) && defined(CONFIG_SDRAM_MT46H32M32LFCM)
/* Micron part of 3621 EDP1 (166MHz optimized) 6.02ns - 128MB
 *     ACTIMA
 *        -TDAL = Twr/Tck + Trp/tck = 15/6 + 18/6 = 2.5 + 3 = 5.5 -> 6
 *        -TDPL (Twr) = 15/6       = 2.5 -> 3
 *        -TRRD = 12/6     = 2
...
#elif defined(CONFIG_3621EDP1) && defined(CONFIG_SDRAM_MT46H64M32LF)
/* Micron part of 3621 EDP1 (166MHz optimized) 6.02ns - 256MB
 *     ACTIMA
 *        -TDAL = Twr/Tck + Trp/tck = 15/6 + 18/6 = 2.5 + 3 = 5.5 -> 6
 *        -TDPL (Twr) = 15/6       = 2.5 -> 3
 *        -TRRD = 12/6     = 2
...
#elif defined(CONFIG_3621EDP1) && defined(CONFIG_DDR_EDK2232CBBH_50_F)
//-----------------------------------------------------------------------------
/* ELPIDA part of 3621 EDP1 (200MHz optimized) 5ns - 256MB
 *     ACTIMA
 ...
 *        -TXSR => TSREX = 120/5 = 24
 */
#define ELPIDA_TDAL_200   6
#define ELPIDA_TDPL_200   3
#define ELPIDA_TRRD_200   2
#define ELPIDA_TRCD_200   3
#define ELPIDA_TRP_200    3
#define ELPIDA_TRAS_200   8
#define ELPIDA_TRC_200    11
#define ELPIDA_TRFC_200   16
#define ELPIDA_V_ACTIMA_200 ((ELPIDA_TRFC_200 << 27) | (ELPIDA_TRC_200 << 22) | (ELPIDA_TRAS_200 << 18) \
		                | (ELPIDA_TRP_200 << 15) | (ELPIDA_TRCD_200 << 12) |(ELPIDA_TRRD_200 << 9) | \
		                (ELPIDA_TDPL_200 << 6) | (ELPIDA_TDAL_200))

#define ELPIDA_TWTR_200   2
#define ELPIDA_TCKE_200   2
#define ELPIDA_TXP_200    1
#define ELPIDA_XSR_200    24
#define ELPIDA_V_ACTIMB_200 ((ELPIDA_TCKE_200 << 12) | (ELPIDA_XSR_200 << 0)) | \
	              ( ELPIDA_TXP_200 << 8)  | (ELPIDA_TWTR_200 << 16)
//-----------------------------------------------------------------------------
/* ELPIDA part of 3621 EDP1 (166MHz optimized) 6.02ns - 256MB
 *     ACTIMA
 *        -TDAL = Twr/Tck + Trp/tck = 15/6 + 18/6 = 2.5 + 3 = 5.5 -> 6
 *        -TDPL (Twr) = 15/6 = 2.5 -> 3
 *        -TRRD = 12/6     = 2
 ...
 *        -TXSR => TSREX = 120/6 = 20
 */
#define ELPIDA_TDAL_165   6 //6
#define ELPIDA_TDPL_165   3 //3
#define ELPIDA_TRRD_165   2 //2
#define ELPIDA_TRCD_165   3 //3
#define ELPIDA_TRP_165    3 //3
#define ELPIDA_TRAS_165   8 //7
#define ELPIDA_TRC_165    11 //10
#define ELPIDA_TRFC_165   16 //13
#define ELPIDA_V_ACTIMA_165 ((ELPIDA_TRFC_165 << 27) | (ELPIDA_TRC_165 << 22) | (ELPIDA_TRAS_165 << 18) \
		                | (ELPIDA_TRP_165 << 15) | (ELPIDA_TRCD_165 << 12) |(ELPIDA_TRRD_165 << 9) | \
		                (ELPIDA_TDPL_165 << 6) | (ELPIDA_TDAL_165))

#define ELPIDA_TWTR_165   2 //1
#define ELPIDA_TCKE_165   2 //2
#define ELPIDA_TXP_165    1 //1
#define ELPIDA_XSR_165    24 //20
#define ELPIDA_V_ACTIMB_165 ((ELPIDA_TCKE_165 << 12) | (ELPIDA_XSR_165 << 0)) | \
	              ( ELPIDA_TXP_165 << 8)  | (ELPIDA_TWTR_165 << 16)

#define V_ACTIMA_133	ELPIDA_V_ACTIMA_165
#define V_ACTIMB_133	ELPIDA_V_ACTIMB_165

#define V_ACTIMA_165 	ELPIDA_V_ACTIMA_165
#define V_ACTIMB_165 	ELPIDA_V_ACTIMB_165

#define V_ACTIMA_200 	ELPIDA_V_ACTIMA_200
#define V_ACTIMB_200 	ELPIDA_V_ACTIMB_200
//&*&*&*20110223_Peter --
...
//&*&*&*20110223_Peter ++
#if defined (CONFIG_DDR_EDK2232CBBH_50_F)
