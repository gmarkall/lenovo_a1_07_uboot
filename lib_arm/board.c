...
{
	printf ("\n\n%s\n\n", version_string);
	#ifdef CONFIG_SVN_REVISION
	printf ("SVN Revision:%d\n", CONFIG_SVN_REVISION);/* <--LH_SWRD_CL1_Mervins@2011.05.19--> */
	#endif
...
/* <--LH_SWRD_CL1_Mervins@2011.09.14: set 3G flag --> */	
#ifdef CONFIG_CL1_3G_VERSION
	share_region->status_3G_exist = 1;
#else
/*
	if(g_BoardID==7||g_BoardID==8||g_BoardID==9)
		share_region->status_3G_exist = 1;
	else
		share_region->status_3G_exist = 0;
*/
	share_region->status_3G_exist = 0;
#endif
	run_command("mmcinit 1; mmc 1 read 82000000 2e00000 400", 0);
